...
import (
	...
	"github.com/stackvista/sandbox-operator/pkg/client/versioned/scheme"
...
// DevopsV1Client is used to interact with features provided by the devops.stackstate.com group.
type DevopsV1Client struct {
	restClient rest.Interface
}

func (c *DevopsV1Client) Sandboxes() SandboxInterface {
	return newSandboxes(c)
}
